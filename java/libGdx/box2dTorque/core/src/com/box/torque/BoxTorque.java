...
public class BoxTorque extends ApplicationAdapter implements InputProcessor{
    ...
    public boolean keyDown (int keycode) {
     ...
     // On right or left arrow set the velocity at a fixed rate in that direction
        ...
        // If user hits space bar, reset everything back to normal
